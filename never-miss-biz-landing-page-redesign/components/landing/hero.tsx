  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#09090b] pt-16 md:pt-32 pb-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="h-[30px] md:h-[120px]" aria-hidden="true" />
        ...
        <motion.div
          ...
          className="text-center mt-[280px] md:mt-[360px]"
        >
          <span
            className="text-2xl md:text-3xl font-bold text-[#F4D976]"
            style={{ textShadow: "0 0 24px rgba(212,175,55,0.9), 0 0 48px rgba(212,175,55,0.5)" }}
          >
